                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
                  ...
                  <div className="flex flex-col mt-1">
                    ...
                    <p className="text-center mt-3 text-xs text-text-muted">
                      Ou{' '}
                      <button type="button" onClick={handleWhatsApp} className="text-gold underline hover:no-underline">
              ...
              >
                ...
                {(emailResult === 'failed' || !EMAILJS_CONFIGURED) && (
                  <div className="flex flex-col sm:flex-row gap-3 w-full mt-2">
                    <a href={buildMailto()} className="btn-primary flex-1 justify-center py-3 text-sm">Envoyer par email</a>
                    <a href={buildWA()} target="_blank" rel="noopener noreferrer" className="flex flex-1 items-center justify-center gap-2 py-3 rounded-sm font-sans font-semibold text-sm bg-[#25D366]/15 text-[#25D366] border border-[#25D366]/30 hover:bg-[#25D366]/25 transition-colors">
