...
import { EMAIL, buildWhatsAppUrl } from '../../inventory/inventoryService'
          ...
          >
            {!submitted ? (
              ...
              >
                ...
                <a
                  href={buildWhatsAppUrl(`Bonjour, je viens d'envoyer une demande de financement. Mon nom est ${form.name}.`)}
                  target="_blank"
